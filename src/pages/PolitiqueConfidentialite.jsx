        ...
        <div className="space-y-10 text-text-light font-light leading-relaxed">
          ...
          <Section number="1" title="Responsable du traitement" icon={Shield}>
            <p>
              ...
              Email de contact RGPD : <a href="mailto:contact@doiryshop.com" className="text-accent hover:underline">contact@doiryshop.com</a>
            </p>
          </Section>
          ...
          <Section number="5" title="Droits des utilisateurs" icon={UserCheck}>
            ...
            <p className="mt-4">
              Pour exercer vos droits, vous pouvez nous contacter par email à <strong className="text-accent">contact@doiryshop.com</strong>. 
